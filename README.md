...
![Этапы разработки](images/timeline.png)

На схеме отображены задачи, которые необходимо выполнить и ответственные за нее. Например: "Каркас бота (TL + Backend2)" - "Создаем основу бота на AIogram для приема сообщений и базовыми хендлерами для обработки команд и текстовых сообщений. Ответственные - TL и Backend2" или "Интеграция (TL)": "сборка всех компонентов системы. Ответственный - TL".
